...
public class RefreshLayout extends ViewGroup {
    ...
    private Animation.AnimationListener mRefreshListener = new Animation.AnimationListener() {
        ...
        public void onAnimationEnd(Animation animation) {
            ...
            LogUtils.LOGD("tag", " mRefreshListener " + mCurrentTargetOffsetTop);
        }
    };
...
//        mCircleView.setImageDrawable(mProgress);
    ...
    private void createProgressView() {
        ...
        mCircleView.setImageResource(R.mipmap.ic_launcher);
        mCircleView.setVisibility(View.GONE);
        addView(mCircleView);
    }
...
//                                * interpolatedTime)));
    ...
    private void setTargetOffsetTopAndBottom(int offset, boolean requiresUpdate) {
        LogUtils.LOGD("tag", "offset " + offset + "    " + mCurrentTargetOffsetTop);
        mCircleView.bringToFront();
        mCircleView.offsetTopAndBottom(offset);
        mCurrentTargetOffsetTop = mCircleView.getTop();
//        mCurrentTargetOffsetTop += offset;
        LogUtils.LOGD("tag", "mCurrentTargetOffsetTop " + mCurrentTargetOffsetTop);
